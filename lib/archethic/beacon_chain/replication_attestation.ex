defmodule Archethic.BeaconChain.ReplicationAttestation do
  ...
  def validate(%__MODULE__{
    ...
    validate_confirmations(confirmations, tx_summary_payload, nodes_public_key)
  end

  defp validate_confirmations([], _, _), do: {:error, :invalid_confirmations_signatures}

  defp validate_confirmations(confirmations, tx_summary_payload, nodes_public_key) do
    valid_confirmations? =
      Enum.all?(confirmations, fn {node_index, signature} ->
        public_key = Enum.at(nodes_public_key, node_index)
