defmodule Archethic.TransactionChain.Transaction.ProofOfValidation do
  ...
  def get_state(sorted_nodes = %SortedNode{}, stamps) do
    ...
    nb_max = get_nb_validation_nodes(sorted_nodes)
  ...
  def valid?(
    ...
    nb_max_validation_nodes = get_nb_validation_nodes(sorted_nodes)
  ...
  defp get_nb_validation_nodes(%SortedNode{nodes: nodes}) do
